...
public class AcceptanceCriterion {
    ...
    public boolean acceptSolution(Solution solution, long totalWorkerCpuTime) {
        if (globalIterator == 0) {
        ...
        switch (stoppingCriterionType) {
            ...
            case Time:
                if (globalIterator % numIterUpdate == 0) {
                    ...
                    double current = (double) (totalWorkerCpuTime + threadMXBean.getCurrentThreadCpuTime() - ini) / 1_000_000_000; // 转换为秒
