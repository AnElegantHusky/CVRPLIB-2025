...
namespace genvrp {
    ...
    class CommandLineParser {
        ...
        /** Path to a shared SQLite database used for cooperation between algorithms. */
        std::string sharedDbPath;
        ...
        /** Interval between two DB updates (seconds). */
    ...
    public:
        ...
        std::string getSharedDbPath() const { assert(commandOk); return sharedDbPath; }
        double getStartTimeSec() const { assert(commandOk); return startTimeSec; }
        int getTimeoutSec() const { assert(commandOk); return timeoutSec; }
        int getUpdateIntervalSec() const { assert(commandOk); return updateIntervalSec; }
