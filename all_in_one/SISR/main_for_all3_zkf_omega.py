...
def manage_workers(process_dict, sisr_args, ails_common_args, ails_configs, filo_template, hgs_template, ails_eoh_acc_template,  ails_eoh_omega_template, best_info, start_time):  # add new template
    """
    智能管理进程重启。
