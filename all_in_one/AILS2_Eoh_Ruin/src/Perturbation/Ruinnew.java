...
// Rulmew: Implements a Route-Based Split Ruin strategy
public class Rulmew extends Perturbation
{
    public Rulmew(Instance instance, Config config,
                  HashMap<String, OmegaAdjustment> omegasetup, IntraLocalSearch intraLocalSearch)
    {
        ...
        this.perturbationType = PerturbationType.Rulmew;
    }
