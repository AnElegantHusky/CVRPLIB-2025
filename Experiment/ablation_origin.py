...
def make_config(one_day_sec):
    ...
    return {
        ...
        # "initial_solution": None,  # path to a .sol file; None means no warm-start seed
        ...
        "tier1": [
            {"name": "E_AILS2_10d", "jar": ROOT_PATH / "AILS2" / "target" / "AILS-II-1.0-SNAPSHOT-jar-with-dependencies.jar",
